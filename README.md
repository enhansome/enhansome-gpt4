...
* [helicone](https://github.com/Helicone/helicone) ⭐ 6,174 | 🐛 159 | 🌐 TypeScript | 📅 2026-09-16 - GPT4 Monitoring and Observability.
* [Smart Connections](https://github.com/brianpetro/obsidian-smart-connections) ⭐ 5,465 | 🐛 494 | 🌐 JavaScript | 📅 2026-09-16 - Chat with the notes in your Obsidian vault using OpenAI GPT-4.
* [Wolverine](https://github.com/biobootloader/wolverine) ⭐ 5,062 | 🐛 28 | 🌐 Python | 📅 2024-03-08 - Run Python scripts, and when they crash, GPT-4 edits them and explains what went wrong.
...
* [GPTDiscord](https://github.com/Kav-K/GPTDiscord) ⭐ 1,851 | 🐛 44 | 🌐 Python | 📅 2026-02-06 - A full OpenAI integration for Discord with multi-modal chat and infinite-length conversations.
...
Prompts and conversations that are especially impressive with GPT-4. Check out [@f/awesome-chatgpt-prompts](https://github.com/f/awesome-chatgpt-prompts) ⭐ 170,972 | 🐛 78 | 🌐 HTML | 📅 2026-09-09 and [awesome-gpt-prompt-engineering](https://github.com/snwfdhmp/awesome-gpt-prompt-engineering) ⭐ 1,632 | 🐛 17 | 🌐 Python | 📅 2026-02-23 as well.
