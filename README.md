...
* [openplayground](https://github.com/nat/openplayground) ⭐ 6,348 | 🐛 106 | 🌐 TypeScript | 📅 2026-02-06 - An LLM playground you can run on your laptop.
* [helicone](https://github.com/Helicone/helicone) ⭐ 6,158 | 🐛 157 | 🌐 TypeScript | 📅 2026-09-13 - GPT4 Monitoring and Observability.
* [Smart Connections](https://github.com/brianpetro/obsidian-smart-connections) ⭐ 5,451 | 🐛 492 | 🌐 JavaScript | 📅 2026-09-15 - Chat with the notes in your Obsidian vault using OpenAI GPT-4.
* [Wolverine](https://github.com/biobootloader/wolverine) ⭐ 5,065 | 🐛 28 | 🌐 Python | 📅 2024-03-08 - Run Python scripts, and when they crash, GPT-4 edits them and explains what went wrong.
...
Prompts and conversations that are especially impressive with GPT-4. Check out [@f/awesome-chatgpt-prompts](https://github.com/f/awesome-chatgpt-prompts) ⭐ 170,406 | 🐛 78 | 🌐 HTML | 📅 2026-09-09 and [awesome-gpt-prompt-engineering](https://github.com/snwfdhmp/awesome-gpt-prompt-engineering) ⭐ 1,625 | 🐛 17 | 🌐 Python | 📅 2026-02-23 as well.
