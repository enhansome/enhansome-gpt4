...
* [helicone](https://github.com/Helicone/helicone) ⭐ 6,068 | 🐛 165 | 🌐 TypeScript | 📅 2026-07-25 - GPT4 Monitoring and Observability.
* [Smart Connections](https://github.com/brianpetro/obsidian-smart-connections) ⭐ 5,359 | 🐛 488 | 🌐 JavaScript | 📅 2026-08-12 - Chat with the notes in your Obsidian vault using OpenAI GPT-4.
...
* [chatgpt-wrapper](https://github.com/mmabrouk/chatgpt-wrapper) ⭐ 3,720 | 🐛 4 | 🌐 Python | 📅 2026-07-15 - API for interacting with ChatGPT and GPT4 using Python and from Shell.
...
Prompts and conversations that are especially impressive with GPT-4. Check out [@f/awesome-chatgpt-prompts](https://github.com/f/awesome-chatgpt-prompts) ⭐ 167,120 | 🐛 65 | 🌐 HTML | 📅 2026-08-14 and [awesome-gpt-prompt-engineering](https://github.com/snwfdhmp/awesome-gpt-prompt-engineering) ⭐ 1,610 | 🐛 16 | 🌐 Python | 📅 2026-02-23 as well.
