...
* [helicone](https://github.com/Helicone/helicone) ⭐ 6,095 | 🐛 152 | 🌐 TypeScript | 📅 2026-08-23 - GPT4 Monitoring and Observability.
* [Smart Connections](https://github.com/brianpetro/obsidian-smart-connections) ⭐ 5,389 | 🐛 489 | 🌐 JavaScript | 📅 2026-08-22 - Chat with the notes in your Obsidian vault using OpenAI GPT-4.
* [Wolverine](https://github.com/biobootloader/wolverine) ⭐ 5,072 | 🐛 27 | 🌐 Python | 📅 2024-03-08 - Run Python scripts, and when they crash, GPT-4 edits them and explains what went wrong.
...
* [Anse](https://github.com/anse-app/anse) ⭐ 1,973 | 🐛 41 | 🌐 TypeScript | 📅 2025-05-12 - Supercharged experience for ChatGPT, DALL-E, and Stable Diffusion.
...
* [GPTDiscord](https://github.com/Kav-K/GPTDiscord) ⭐ 1,854 | 🐛 43 | 🌐 Python | 📅 2026-02-06 - A full OpenAI integration for Discord with multi-modal chat and infinite-length conversations.
...
Prompts and conversations that are especially impressive with GPT-4. Check out [@f/awesome-chatgpt-prompts](https://github.com/f/awesome-chatgpt-prompts) ⭐ 167,795 | 🐛 68 | 🌐 HTML | 📅 2026-08-23 and [awesome-gpt-prompt-engineering](https://github.com/snwfdhmp/awesome-gpt-prompt-engineering) ⭐ 1,613 | 🐛 16 | 🌐 Python | 📅 2026-02-23 as well.
