...
* [helicone](https://github.com/Helicone/helicone) ⭐ 6,060 | 🐛 159 | 🌐 TypeScript | 📅 2026-07-25 - GPT4 Monitoring and Observability.
* [Smart Connections](https://github.com/brianpetro/obsidian-smart-connections) ⭐ 5,358 | 🐛 488 | 🌐 JavaScript | 📅 2026-08-12 - Chat with the notes in your Obsidian vault using OpenAI GPT-4.
* [Wolverine](https://github.com/biobootloader/wolverine) ⭐ 5,075 | 🐛 27 | 🌐 Python | 📅 2024-03-08 - Run Python scripts, and when they crash, GPT-4 edits them and explains what went wrong.
* [chatgpt-wrapper](https://github.com/mmabrouk/chatgpt-wrapper) ⭐ 3,720 | 🐛 3 | 🌐 Python | 📅 2026-07-15 - API for interacting with ChatGPT and GPT4 using Python and from Shell.
* [Anse](https://github.com/anse-app/anse) ⭐ 1,975 | 🐛 41 | 🌐 TypeScript | 📅 2025-05-12 - Supercharged experience for ChatGPT, DALL-E, and Stable Diffusion.
* [DemoGPT](https://github.com/melih-unsal/DemoGPT) ⭐ 1,904 | 🐛 10 | 🌐 Python | 📅 2026-04-01 - DemoGPT enables you to create quick demos by just using prompts.
* [GPTDiscord](https://github.com/Kav-K/GPTDiscord) ⭐ 1,855 | 🐛 43 | 🌐 Python | 📅 2026-02-06 - A full OpenAI integration for Discord with multi-modal chat and infinite-length conversations.
* [gpt-voice-conversation-chatbot](https://github.com/Adri6336/gpt-voice-conversation-chatbot) ⭐ 302 | 🐛 6 | 🌐 Python | 📅 2024-05-05 - Conversational GPT-4 bot that has memory, ElevenLabs/Google TTS, voice-chat/CLI options, customization, and is not token-limited.
...
* [GPT-4 Unlimited Tools](https://github.com/d3n7/GPT-4-Unlimited-Tools) ⭐ 276 | 🐛 0 | 🌐 Python | 📅 2023-04-23 - GPT-4 with internet and command line access.
* [GPT-Prompter](https://github.com/giosilvi/GPT-Prompter) ⚠️ Archived - Browser extension to get a fast prompt for OpenAI's GPT-3, GPT-4 & ChatGPT API.
* [Pair](https://github.com/jiggy-ai/pair) ⭐ 239 | 🐛 4 | 🌐 Python | 📅 2024-09-29 - An iterative, stateful chat-like interface for programmers to pair programming with GPT-4.
* [doctorgpt](https://github.com/ingyamilmolinar/doctorgpt) ⭐ 210 | 🐛 0 | 🌐 Go | 📅 2023-05-10 - Production log error diagnosing.
* [ChatGPTify](https://github.com/idilsulo/ChatGPTify) ⭐ 206 | 🐛 3 | 🌐 Python | 📅 2024-01-20 - Spotify playlist generator via ChatGPT (and GPT-4).
* [promptlib](https://github.com/jmpaz/promptlib/) ⭐ 195 | 🐛 3 | 🌐 Jupyter Notebook | 📅 2023-08-08 - A collection of prompts for use with GPT-4 via ChatGPT, OpenAI API w/ Gradio frontend.
...
* [StockGPT](https://github.com/d3n7/StockGPT) ⭐ 122 | 🐛 0 | 🌐 Python | 📅 2023-04-24 - Primitive technique to predict stock movements with GPT-4 or 3.5.
* [MusicGPT](https://github.com/d3n7/GPT-4-To-MIDI) ⭐ 70 | 🐛 3 | 🌐 Python | 📅 2024-05-21 - Make polyphonic music in the form of MIDI files with GPT-4 or 3.5.
...
Prompts and conversations that are especially impressive with GPT-4. Check out [@f/awesome-chatgpt-prompts](https://github.com/f/awesome-chatgpt-prompts) ⭐ 167,071 | 🐛 65 | 🌐 HTML | 📅 2026-08-13 and [awesome-gpt-prompt-engineering](https://github.com/snwfdhmp/awesome-gpt-prompt-engineering) ⭐ 1,610 | 🐛 16 | 🌐 Python | 📅 2026-02-23 as well.
