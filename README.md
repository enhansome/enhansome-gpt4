...
* [helicone](https://github.com/Helicone/helicone) ⭐ 6,147 | 🐛 156 | 🌐 TypeScript | 📅 2026-08-31 - GPT4 Monitoring and Observability.
* [Smart Connections](https://github.com/brianpetro/obsidian-smart-connections) ⭐ 5,448 | 🐛 491 | 🌐 JavaScript | 📅 2026-09-10 - Chat with the notes in your Obsidian vault using OpenAI GPT-4.
* [Wolverine](https://github.com/biobootloader/wolverine) ⭐ 5,067 | 🐛 27 | 🌐 Python | 📅 2024-03-08 - Run Python scripts, and when they crash, GPT-4 edits them and explains what went wrong.
...
Prompts and conversations that are especially impressive with GPT-4. Check out [@f/awesome-chatgpt-prompts](https://github.com/f/awesome-chatgpt-prompts) ⭐ 169,963 | 🐛 77 | 🌐 HTML | 📅 2026-09-09 and [awesome-gpt-prompt-engineering](https://github.com/snwfdhmp/awesome-gpt-prompt-engineering) ⭐ 1,621 | 🐛 17 | 🌐 Python | 📅 2026-02-23 as well.
